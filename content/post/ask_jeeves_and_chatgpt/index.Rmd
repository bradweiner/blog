...
If students can use ChatGPT to generate seemingly original work, then how are we going to train^[ML joke bingo!] students to think critically, write convincing arguments or not pass off AI-generated work as their own?
...
That being said, I am not convinced (yet) that these AI tools can so dramatically upend the academic enterprise. This is largely because education is so much more that completing assignments and getting grades. Students (in my view) will continue to pursue the educational experiences that allow them opportunities to the big, thorny, difficult problems that require more than a mediocre AI-generated essay. 
