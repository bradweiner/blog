...
One of those calls was with a data science manager from a well-known electric car company run by an eclectic billionaire. The opportunity seemed awesome. It would be with a real DS team^[By this, I mean a team using open source tools, in a collaborative, version-controlled workflow, in a company that could rapidly generate value based on analytic findings]. It was in California. Options were available. All the things.
